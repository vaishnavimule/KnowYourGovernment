...
public class DataExtractor extends AsyncTask<String, Void, String> {

    private static final String TAG = "DataExtractor";
    private MainActivity mainActivity;
    private String prefix = "https://www.googleapis.com/civicinfo/v2/representatives?key=AIzaSyAYDs4gKQ_8pjtFasY1eAY2jAZorHnKH9s&address=";

    public DataExtractor(MainActivity mainActivity) {
